...
def create_pull_request(new_branch_name, repo_owner, repo_name, base_branch, head_owner, is_own_repo=False):
    """
    ...
    # Different PR body based on whether it's from a fork or same repo
    if is_own_repo:
